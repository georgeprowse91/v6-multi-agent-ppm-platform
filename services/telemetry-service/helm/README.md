...
- [files](/services/telemetry-service/helm/files): Subdirectory containing files assets for this area.
- [templates](/services/telemetry-service/helm/templates): Templates used by the component (deployment or message content).
- [Chart.yaml](/services/telemetry-service/helm/Chart.yaml): Helm chart metadata and versioning.
- [values.yaml](/services/telemetry-service/helm/values.yaml): Helm values for environment-specific overrides.
