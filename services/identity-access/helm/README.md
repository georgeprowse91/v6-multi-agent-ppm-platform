...
- [templates](/services/identity-access/helm/templates): Templates used by the component (deployment or message content).
- [Chart.yaml](/services/identity-access/helm/Chart.yaml): Helm chart metadata and versioning.
- [values.yaml](/services/identity-access/helm/values.yaml): Helm values for environment-specific overrides.
