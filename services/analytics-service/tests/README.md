...
Document the tests assets for the Analytics Service application.

## What's inside

- [test_scheduler.py](/services/analytics-service/tests/test_scheduler.py): Python module used by this component.
...
```bash
ls services/analytics-service/tests
```
