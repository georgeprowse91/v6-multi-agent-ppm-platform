...
- [manifests](/services/analytics-service/jobs/manifests): Kubernetes or job manifests stored here.
- [schema](/services/analytics-service/jobs/schema): Schemas or validation rules for component assets.
...
```bash
ls services/analytics-service/jobs
```
