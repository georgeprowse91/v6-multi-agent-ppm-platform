...
DEFAULT_HEALTH_SNAPSHOT_DB = os.getenv(
    ...
    "services/analytics-service/storage/health_snapshots.json",
)
...
DEFAULT_METRICS_DB = os.getenv(
    ...
    "services/analytics-service/storage/metrics.db",
)
DEFAULT_AGENT_OUTPUT_DB = os.getenv(
    "ANALYTICS_AGENT_OUTPUT_DB",
    "services/analytics-service/storage/agent_outputs.json",
)
...
async def startup() -> None:
    ...
    db_path = Path(
        os.getenv("ANALYTICS_SCHEDULER_DB", "services/analytics-service/storage/scheduler.db")
    )
