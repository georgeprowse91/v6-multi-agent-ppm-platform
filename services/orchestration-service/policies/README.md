...
- [bundles](/services/orchestration-service/policies/bundles): Subdirectory containing bundles assets for this area.
- [schema](/services/orchestration-service/policies/schema): Schemas or validation rules for component assets.
...
```bash
ls services/orchestration-service/policies
```
