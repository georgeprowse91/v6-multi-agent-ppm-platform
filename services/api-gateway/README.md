...
- [helm](/services/api-gateway/helm): Helm chart packaging for Kubernetes deployments.
- [openapi](/services/api-gateway/openapi): OpenAPI artifacts and generated summaries.
- [src](/services/api-gateway/src): Implementation source for this component.
- [tests](/services/api-gateway/tests): Test suites and fixtures.
- [Dockerfile](/services/api-gateway/Dockerfile): Container build recipe for local or CI use.
...
If none are set, the API applies environment defaults in `services/api-gateway/src/api/main.py`:
