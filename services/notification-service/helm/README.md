...
- [templates](/services/notification-service/helm/templates): Templates used by the component (deployment or message content).
- [Chart.yaml](/services/notification-service/helm/Chart.yaml): Helm chart metadata and versioning.
- [values.yaml](/services/notification-service/helm/values.yaml): Helm values for environment-specific overrides.
