...
- [helm](/services/admin-console/helm): Helm chart packaging for Kubernetes deployments.
- [tests](/services/admin-console/tests): Test suites and fixtures.
- [Dockerfile](/services/admin-console/Dockerfile): Container build recipe for local or CI use.
