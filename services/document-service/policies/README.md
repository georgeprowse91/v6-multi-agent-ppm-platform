...
- [bundles](/services/document-service/policies/bundles): Subdirectory containing bundles assets for this area.
- [schema](/services/document-service/policies/schema): Schemas or validation rules for component assets.
...
```bash
ls services/document-service/policies
```
