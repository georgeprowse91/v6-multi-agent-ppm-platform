...
Document infrastructure resources under infra/policies/security.

## What's inside

- [bundles](/infra/policies/security/bundles): Subdirectory containing bundles assets for this area.
