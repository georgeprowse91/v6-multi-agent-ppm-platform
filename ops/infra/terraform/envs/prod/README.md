...
- [backend.tfvars](/infra/terraform/envs/prod/backend.tfvars): File asset used by this component.
- [terraform.tfvars](/infra/terraform/envs/prod/terraform.tfvars): File asset used by this component.
