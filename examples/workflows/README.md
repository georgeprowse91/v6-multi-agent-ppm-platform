...
- [portfolio-intake.workflow.yaml](/examples/workflows/portfolio-intake.workflow.yaml): YAML definition or configuration used by this component.
- [mcp-cross-system.workflow.yaml](/examples/workflows/mcp-cross-system.workflow.yaml): MCP-focused cross-system workflow example.
