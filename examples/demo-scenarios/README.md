...
Provide demo scenarios examples that demonstrate how to use the platform assets.

## What's inside

- `quickstart-request.json`: Canonical multi-agent query input for the quickstart.
...
Review example files directly and adapt them for your environment. The quickstart runbook
uses these assets verbatim.
