...
| **Agent 07 – Program Management** | Manage program structure, dependencies. | Project list, dependencies. | Program roadmap, dependency map. | API, events. | Project agent, schedule agent. | `{"program":"Payments","projects":["P1","P2"]}` |
