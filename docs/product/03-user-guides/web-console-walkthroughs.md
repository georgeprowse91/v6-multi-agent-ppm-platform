...
**Purpose:** Operational walkthrough set for the React web console guided tour experience. Covers how onboarding tours work, how to replay them, and what each tour covers.
**Audience:** Platform end users and administrators.
**Owner:** Platform Operations
**Last reviewed:** 2026-02-20
**Related docs:** [README.md](README.md) · [../03-delivery-and-quality/compliance-evidence-process.md](../03-delivery-and-quality/compliance-evidence-process.md)

> **Migration note:** Moved from `user-guides/web-console-walkthroughs.md` on 2026-02-20.
