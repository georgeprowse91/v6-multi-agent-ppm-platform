...
- `docs/architecture/adr`: Subdirectory containing adr assets for this area.
- `docs/architecture/diagrams`: Subdirectory containing diagrams assets for this area.
- `docs/architecture/agent-orchestration.md`: Markdown documentation for this area.
