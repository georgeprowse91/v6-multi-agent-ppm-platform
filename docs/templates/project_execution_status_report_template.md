...
- Canonical manifest/template: [Manifest](./core/status-report/manifest.yaml)
- Extension patch: [Status Report.patch](./extensions/waterfall/status-report.patch.yaml)
