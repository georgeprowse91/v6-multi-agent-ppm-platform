...
- Canonical manifest/template: [Manifest](./core/product-backlog/manifest.yaml)
- Extension patch: [Product Backlog.patch](./extensions/agile/product-backlog.patch.yaml)
