...
- Canonical manifest/template: [Manifest](./core/sprint-planning/manifest.yaml)
- Extension patch: [Sprint Planning.patch](./extensions/agile/sprint-planning.patch.yaml)
