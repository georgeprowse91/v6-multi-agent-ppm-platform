...
- Canonical manifest/template: [Manifest](./core/project-charter/manifest.yaml)
- Extension patch: [Project Charter.patch](./extensions/waterfall/project-charter.patch.yaml)
