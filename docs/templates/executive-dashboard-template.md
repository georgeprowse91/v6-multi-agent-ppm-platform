...
- Deprecated: use `./core/executive-dashboard/manifest.yaml`
- Migration timeline/date: `announce-now; transition-until-2026-03-31; retire-2026-06-30`
- Canonical manifest/template: [Manifest](./core/executive-dashboard/manifest.yaml)
- Extension patch: [Executive Dashboard.patch](./extensions/safe/executive-dashboard.patch.yaml)
