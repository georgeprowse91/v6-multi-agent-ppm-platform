...
async def test_mapping_and_schema_validation() -> None:
    agent = DataSyncAgent(
        config={
            "mapping_rules_path": "ops/config/data-synchronisation-agent/mapping_rules.yaml",
            "schema_registry_path": "ops/config/data-synchronisation-agent/schema_registry.yaml",
        }
    )
