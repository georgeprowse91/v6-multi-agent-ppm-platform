...
|------|-------------|------|
| `eval` | Evaluation framework for testing and benchmarking agent behaviour. | [](/./eval/) |
| `prompts` | Prompt templates, a prompt registry, example prompts, and schema definitions. | [](/./prompts/) |
| `src` | Core runtime implementation including the orchestrator, base agent, state store, and event bus. | [](/./src/) |
