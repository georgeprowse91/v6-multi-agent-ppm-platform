...
- [fixtures](/integrations/connectors/servicenow/tests/fixtures): Subdirectory containing fixtures assets for this area.
...
```bash
pytest integrations/connectors/servicenow/tests
```
