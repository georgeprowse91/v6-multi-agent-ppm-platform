...
- [manifests](/apps/analytics-service/jobs/manifests): Kubernetes or job manifests stored here.
- [schema](/apps/analytics-service/jobs/schema): Schemas or validation rules for component assets.
