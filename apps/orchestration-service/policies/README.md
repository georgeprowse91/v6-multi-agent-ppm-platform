...
- [bundles](/apps/orchestration-service/policies/bundles): Subdirectory containing bundles assets for this area.
- [schema](/apps/orchestration-service/policies/schema): Schemas or validation rules for component assets.
