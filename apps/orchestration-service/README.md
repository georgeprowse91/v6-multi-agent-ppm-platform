...
- [helm](/apps/orchestration-service/helm): Helm chart packaging for Kubernetes deployments.
- [planners](/apps/orchestration-service/planners): Planning templates and orchestration hints.
- [policies](/apps/orchestration-service/policies): Policy definitions enforced by the platform.
- [src](/apps/orchestration-service/src): Implementation source for this component.
- [tests](/apps/orchestration-service/tests): Test suites and fixtures.
- [Dockerfile](/apps/orchestration-service/Dockerfile): Container build recipe for local or CI use.
