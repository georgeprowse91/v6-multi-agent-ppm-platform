...
- [templates](/apps/document-service/helm/templates): Templates used by the component (deployment or message content).
- [Chart.yaml](/apps/document-service/helm/Chart.yaml): Helm chart metadata and versioning.
- [values.yaml](/apps/document-service/helm/values.yaml): Helm values for environment-specific overrides.
