...
- [helm](/apps/api-gateway/helm): Helm chart packaging for Kubernetes deployments.
- [openapi](/apps/api-gateway/openapi): OpenAPI artifacts and generated summaries.
- [src](/apps/api-gateway/src): Implementation source for this component.
- [tests](/apps/api-gateway/tests): Test suites and fixtures.
- [Dockerfile](/apps/api-gateway/Dockerfile): Container build recipe for local or CI use.
