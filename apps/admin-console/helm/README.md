...
- `apps/admin-console/helm/templates`: Templates used by the component (deployment or message content).
- `apps/admin-console/helm/Chart.yaml`: Helm chart metadata and versioning.
- `apps/admin-console/helm/values.yaml`: Helm values for environment-specific overrides.
