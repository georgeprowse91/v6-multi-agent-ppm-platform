...
from .stubs import orchestrate as _orchestrate
from .stubs import route_intent as _route_intent
from .stubs import run_domain_agent
...
def run_agent(
    ...
    return run_domain_agent(
        store, agent_id=agent_id, actor=actor, entity_id=entity_id, inputs=inputs
    )
