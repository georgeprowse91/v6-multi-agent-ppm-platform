...
- [helm](/apps/workflow-service/helm): Helm chart packaging for Kubernetes deployments.
- [migrations](/apps/workflow-service/migrations): Database migration scripts and notes.
- [src](/apps/workflow-service/src): Implementation source for this component.
- [tests](/apps/workflow-service/tests): Test suites and fixtures.
- [workflows](/apps/workflow-service/workflows): Workflow definitions and examples.
- [Dockerfile](/apps/workflow-service/Dockerfile): Container build recipe for local or CI use.
