...
- `integrations/apps/connector-hub/sandbox/examples`: Example configurations and demo scenarios.
- `integrations/apps/connector-hub/sandbox/fixtures`: Subdirectory containing fixtures assets for this area.
- `integrations/apps/connector-hub/sandbox/schema`: Schemas or validation rules for component assets.
