...
- [integrations/connectors/teams/tests/fixtures](/integrations/connectors/teams/tests/fixtures): Subdirectory containing fixtures assets for this area.
...
```bash
pytest integrations/connectors/teams/tests
```
