...
- `integrations/connectors/salesforce/tests/fixtures`: Subdirectory containing fixtures assets for this area.
...
```bash
pytest integrations/connectors/salesforce/tests
```
